...
{
	class BufferD3D12 : RefCounter<IBuffer>, BufferStateExtension
	{
		...
		public this(D3D12Context* context, DeviceResources resources, BufferDesc desc)
		{
			this.desc = desc;
			m_Context = context;
		...
		public static void createNullSRV(int descriptor, Format format, D3D12Context* context)
		{
		...
		public static void createNullUAV(int descriptor, Format format, D3D12Context* context)
		{
			readonly ref DxgiFormatMapping mapping = ref getDxgiFormatMapping(format == Format.UNKNOWN ? Format.R32_UINT : format);
