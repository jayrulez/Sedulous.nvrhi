...
class ShaderTableD3D12 : RefCounter<nvrhi.rt.IShaderTable>
{
	public struct Entry
	{
	...
	public RefCountPtr<RayTracingPipelineD3D12> pipeline;
	...
	public this(D3D12Context* context, RayTracingPipelineD3D12 _pipeline)
	{
		pipeline = _pipeline;
		m_Context = context;
	}
	...
	{
		readonly RayTracingPipelineD3D12.ExportTableEntry* pipelineExport = pipeline.getExport(exportName);
	...
	private bool verifyExport(RayTracingPipelineD3D12.ExportTableEntry* pExport, IBindingSet bindings)
	{
		if (pExport == null)
		{
		...
		if (bindings != null && (checked_cast<nvrhi.d3d12.BindingSetD3D12, IBindingSet>(bindings).layout != pExport.bindingLayout))
		{
