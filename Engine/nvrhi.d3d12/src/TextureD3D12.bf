...
{
	class TextureD3D12 : RefCounter<ITexture>, TextureStateExtension
	{
		...
		public this(D3D12Context* context, DeviceResources resources, TextureDesc desc, D3D12_RESOURCE_DESC resourceDesc)
		{
			this.desc = desc;
